...
import { type BreadcrumbItem, type Branch, type CommonService } from '@/types';
...
export default function ServiceTypeCreate({ branches, commonServices, auth }: Props) {
                        ...
                        {isAdmin && branches && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Select which branch this service type belongs to</CardDescription>
                                </CardHeader>
                                <CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="code"
                                        placeholder="e.g., PMS (Leave empty to auto-generate)"
                                        value={data.code}
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2 text-sm text-muted-foreground">
                                ...
                                <p>• Code auto-generates if left empty</p>
