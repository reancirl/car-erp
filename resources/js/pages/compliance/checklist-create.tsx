...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: '/compliance/checklists/create',
    },
];

export default function ComplianceChecklistCreate({
    branches,
    assignedUsers,
    roles,
    categoryOptions,
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        status: 'active',
        frequency_type: frequencyOptions?.[0]?.value ?? 'monthly',
        ...
        advance_reminder_offsets: [] as string[],
        items: [
            {
                title: '',
                description: '',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Compliance Checklist" />
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <Button type="submit" disabled={processing}>
                            ...
                            {processing ? 'Saving...' : 'Save Checklist'}
                        </Button>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Core information that identifies the compliance requirement.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        placeholder="Outline the scope, checkpoints, and references for this checklist."
                                        rows={4}
                                    />
                                </div>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define how often this checklist is generated and when it becomes due.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define the actionable steps required to complete the checklist.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                        ...
                                        <div key={index} className="border rounded-lg p-4 space-y-3">
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <Textarea
                                                    ...
                                                    placeholder="Describe what needs to be verified or captured."
                                                    rows={3}
                                                />
                    ...
                    <div className="space-y-6">
                        {branches && (
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Select which branch owns this compliance checklist.</CardDescription>
                                </CardHeader>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Choose the primary owner and escalation path.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Configure early reminders and escalation triggers.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
