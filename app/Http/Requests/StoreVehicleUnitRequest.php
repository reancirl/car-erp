...
class StoreVehicleUnitRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Normalize JSON payloads that sometimes arrive as strings
        $jsonFields = [
            'gps_details',
            'insurance_details',
            'promo_freebies',
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'payment_method' => ['nullable', Rule::in(['cash', 'bank_financing', 'in_house'])],
            'proof_of_payment_refs' => 'nullable|array',
            'proof_of_payment_refs.*' => 'string|max:500',
            'dealer' => 'nullable|string|max:255',
            'sales_agent_id' => 'nullable|exists:users,id',
            'assigned_driver_id' => 'nullable|exists:users,id',
            'gps_details' => 'nullable|array',
            'insurance_details' => 'nullable|array',
            'promo_freebies' => 'nullable|array',
            'srp_amount' => 'nullable|numeric|min:0',
            'discount_amount' => 'nullable|numeric|min:0',
            'net_selling_price' => 'nullable|numeric|min:0',
            'dp_amount' => 'nullable|numeric|min:0',
            'dp_date' => 'nullable|date',
            'balance_financed' => 'nullable|numeric|min:0',
            'financing_institution' => 'nullable|string|max:255',
            'financing_terms_months' => 'nullable|integer|min:0',
            'financing_interest_rate' => 'nullable|numeric|min:0',
            'financing_monthly_amortization' => 'nullable|numeric|min:0',
            'chattel_mortgage_details' => 'nullable|array',
            'sales_invoice_no' => 'nullable|string|max:255',
            'dr_no' => 'nullable|string|max:255',
            'or_numbers' => 'nullable|array',
            'or_numbers.*' => 'string|max:255',
            'release_checklist_status' => 'nullable|array',
            'release_approval_user_id' => 'nullable|exists:users,id',
            'freebies_list' => 'nullable|array',
            'freebies_total_cost' => 'nullable|numeric|min:0',
            'freebies_payer' => ['nullable', Rule::in(['hq', 'cebu', 'other'])],
