...
class StoreComplianceReminderRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $deliveryChannels = collect($this->input('delivery_channels', []))
        ...
        $this->merge([
            'auto_escalate' => $this->boolean('auto_escalate'),
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', Rule::in(ComplianceReminder::STATUSES)],
    ...
    public function attributes(): array
    {
        return [
            ...
            'delivery_channels.*' => 'delivery channel',
        ];
    }
}
