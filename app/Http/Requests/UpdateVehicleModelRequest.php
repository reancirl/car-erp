...
class UpdateVehicleModelRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('vehicle_model.edit');
    }
    ...
    public function rules(): array
    {
        ...
        $vehicleModelId = $vehicleModel instanceof \App\Models\VehicleModel ? $vehicleModel->id : $vehicleModel;

        return [
            // Basic Information
            'make' => ['nullable', 'string', 'max:255'],
            'model' => ['required', 'string', 'max:255'],
            'model_code' => ['nullable', 'string', 'max:255', Rule::unique('vehicle_models', 'model_code')->ignore($vehicleModelId)],
